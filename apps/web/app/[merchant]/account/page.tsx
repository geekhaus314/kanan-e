          ...
          {orders.length === 0 ? (
            <div className="rounded-xl border border-gray-100 bg-white p-12 text-center">
              ...
              <Link
                ...
                className="inline-block rounded-xl bg-brand-600 px-6 py-3 text-sm font-bold text-white hover:bg-brand-700"
              >
                Browse Products
              </Link>
            </div>
            ...
            <div className="space-y-3">
              {orders.map((order) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 transition-colors hover:border-brand-200"
                >
                  <div>
