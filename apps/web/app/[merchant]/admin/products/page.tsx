            ...
            <tbody>
              {products.map((p) => (
                <tr key={p.id} className="border-b border-gray-200">
                  ...
                  <td className="px-4 py-3 font-semibold text-brand-600">${parseFloat(p.basePrice.toString()).toFixed(2)}</td>
                  <td className="px-4 py-3 text-gray-500">{p.stockLevel}</td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link href={`/${merchant}/admin/products/${p.id}`} className="text-sm font-medium text-brand-600 hover:underline">
                      Edit
                    </Link>
                  </td>
                </tr>
              ...
              {products.length === 0 && (
                <tr><td colSpan={7} className="px-4 py-12 text-center text-gray-400">No products yet. Click "+ New Product".</td></tr>
              )}
            </tbody>
          </table>
        </div>
